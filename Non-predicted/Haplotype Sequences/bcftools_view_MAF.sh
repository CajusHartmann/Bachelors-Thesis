#!/bin/bash
#SBATCH -J bcftools_view_MAF
#SBATCH --time=0-10:00
#SBATCH --chdir=/work/hartmaca/bcftools_view_MAF
...
bcftools view -i 'MAF >= 0.01' $VCF/miRNA_positions.vcf -O v -o $VCF/miRNA_positions_filtered_MAF0.01.vcf