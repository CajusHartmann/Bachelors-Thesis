...
coords <- read.table("/data/laub-rna/hiwi/cajus/thesis/Haplotpye_Sequences/non_pred/bcftools_consensus/coordinates.bed", sep = "\t")
name <- coords[task_id, 4]

setwd(paste0("/work/hartmaca/RNAfold_non_pred/", name))
...
#save
image_write(result, paste0("/work/hartmaca/RNAfold_non_pred/merged_pdfs/", name, ".png"))
