...
tab <- read.table(file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/statistical_analysis_pred.csv", header = TRUE, sep = ",")
...
p.adjust(c(0.3438, 0.1662, 0.0584, 0.3055, 0.1108), method = "bonferroni")
...
res_b2 <- kruskal.test(num_SNPs~type, data = subset(tab, region == "base_two"))
#I have to adjust the pvalues because I have 5 tests
p.adjust(c(0.485, 0.1426, 0.1063, 0.4524, 0.09588), method = "bonferroni")
