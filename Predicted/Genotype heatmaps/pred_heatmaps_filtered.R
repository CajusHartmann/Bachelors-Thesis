...
for(i in 1:length(positions$name)){
  ...
  matrix <- read.table(file = paste("C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/VIVA/results_all/filtered/", positions[i,1], "_Genotype_MAF0.005_MR0.5_vcf.csv", sep = ""), header = TRUE, sep = ",")  
  #convert positions
  ...
  create_heatmap(t(matrix_all_positions), base_one, miRNA_one, loop, miRNA_two, base_two, 0, 3, name, FALSE, colorscale = list(list(0.0, "white"), list(1/3, "lightblue"), list(2/3, "green"), list(1.0, "red")), path = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Create heatmaps/heatmaps_filtered")
}
