...
#and the position of the miRNA on the x-axis (scaling of the regions the same as in creation of aggregated heatmaps)
...
#read file with overlaps of the 160 miRNAs and the predicted miRNAs
...
medians <- list()
medians$Bidirectional <- 43; medians$BTL <- 51; medians$LTB <- 58; medians$SBTL <- 100; medians$SLTB <- 132
...
for(i in 1:length(merged$name)){
  ...
  matrix <- read.table(file = paste("C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/VIVA/results_all/all/",merged[i,1], "/", "Genotype_miRNA_positions_pred.vcf_matrix.csv", sep = ""), header = TRUE, sep = ",")  
...
write.table(stat$base_one, file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/statistical_analysis.csv", sep = ",", quote = FALSE, row.names = FALSE)
write.table(stat$miRNA_one, file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/statistical_analysis.csv", sep = ",", quote = FALSE, row.names = FALSE, col.names = FALSE, append = TRUE)
write.table(stat$loop, file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/statistical_analysis.csv", sep = ",", quote = FALSE, row.names = FALSE, col.names = FALSE, append = TRUE)
write.table(stat$miRNA_two, file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/statistical_analysis.csv", sep = ",", quote = FALSE, row.names = FALSE, col.names = FALSE, append = TRUE)
write.table(stat$base_two, file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/statistical_analysis.csv", sep = ",", quote = FALSE, row.names = FALSE, col.names = FALSE, append = TRUE)
...
write.table(round(df_percentages,2), file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/percentages.csv", sep = ",", quote = FALSE)
write.table(df_numbers, file = "C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/numbers.csv", sep = ",", quote = FALSE)

#create plots
#iterate over all processing types
for(name in names(all_mats)){
  png(paste("C:/Users/cajus/OneDrive/Dokumente/Bildung/Studium/6. Semester/Bachelorarbeit/Code/Predict miRNAs/Other plots per group/SNP-freq_pos/", name, ".png", sep=""), width = 14, height = 12, units = "cm", res=300)
